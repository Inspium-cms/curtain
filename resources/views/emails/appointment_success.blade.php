...
<body>
    <h1>Appointment @if($appointment->appointment_date) Schduled @else Request Received @endif Successfully</h1>
    ...
    <ul>
        ...
        <li><strong>Appointment Scheduled Date:</strong> {{ $appointment->appointment_date->format('d-m-Y H:i') }}</li>
