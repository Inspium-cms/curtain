...
|-----------------------------------------------------------------------------
|
| Example use (vanilla js): --------------------------------------------------
|
|   <select id="select">
|     <option value="42">Forty two</option>
|   </select>
| 
|   var elem = document.getElementById('select');
|   var select = new Select({ elem: elem });
|   select.render();
|
| Example use (jQuery opt-in): -----------------------------------------------
|
|   <select id="select">
|     <option value="42">Forty two</option>
|   </select>
